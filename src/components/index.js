...
export { FinancielePartners } from '@/components/financielepartners'
export { Media } from '@/components/media'
export { Footer } from '@/components/footer'
export { Header } from '@/components/header'
export { HeroBanner } from '@/components/hero-banner'
export { Doneer } from '@/components/doneer'
...
export { VoortrajectText } from '@/components/voortraject_text'
